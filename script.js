...
window.insertShape = function (type) {
    ...
    if (type === 'square') {
        ...
        div.style.backgroundColor = 'rgba(245, 158, 11, 0.1)'; // Faint orange background for visibility/hit-test
        ...
        div.style.backgroundColor = 'rgba(236, 72, 153, 0.1)'; // Faint pink background
